# 📊 Digital Financial Product & Transaction Performance Analytics

## 📌 Project Overview
This project focuses on analyzing the business and transaction performance of digital financial products 
(QRIS, Top Up, Bill Payment, Loan Revenue, Gold Savings, and Money Transfer). 

Role: Data Analyst / Financial Data Analyst
Industry: Financial Services / Digital Banking / Fintech
...
* **Data Pipeline & BI Dashboarding:** 
  ...
  * Designed a 2-page interactive BI dashboard in **Looker Studio** featuring *Executive KPIs, Target vs. Achievement, Omnichannel Distribution,* 
    and *Product Deep-Dives*.
* **Root Cause Analysis Execution:**
  * Mapped user drop-offs across funnel stages (*Landing Page* $\rightarrow$ *Checkout* $\rightarrow$ *Payment*).
  * Segmented transactional data across *Device/OS, Payment Gateway, User Cohorts,* and *Regions*.
  * Applied the *5 Whys* methodology to isolate technical app crashes on specific OS builds and payment gateway timeout spikes.
